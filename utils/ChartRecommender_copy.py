...
class ChartRecommender:
    ...
    def __init__(self, csv_file: str, word_embedding_dict: dict, column_score_model) -> None:
        ...
        self.charts = self.recommend_chart(self.charts_indices, self.feature_dict, column_score_model)
    ...
    def recommend_chart(self, charts_indices, feature_dict, column_score_model):
        ...
        for cidx, chart_indices in enumerate(charts_indices):
            charts.append({'indices': chart_indices, 'column_selection_score': chart_scores[cidx], 'column_distance': 1 - chart_scores[cidx]})
            # for t in types[cidx]:
    ...
    def enumerate_chart(self, df):
        ...
        charts_indices = []
        for num_selected_columns in range(2,3): 
